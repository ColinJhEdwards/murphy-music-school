  ...
  return [
    {
      ...
      hobbies: "Snails, Mario Kart",
    },
    {
      id: 2,
      name: "Nick Nordstrom",
      description1:
        "Nick, owner of Nordstrom Lumberjacks, found his passion for the bass at a late age but put the entirety of his effort into mastering the instrument. His bass is even made of wood as an homage to his past life.",
      description2:
    ...
    },
    {
      ...
      name: "Michelle Ross",
      description1:
        "Michelle is an award-winning singer, composer, improviser, and record producer.",
      description2:
        "She has composed, recorded, and produced more than 500 compositions and has released dozens of solo and collaborative recordings. Being a self-taught musician has helped her develop a creative approach to teaching her students, creating the opprotunity for even the quietest of students to show their pipes. Michelle is an essential member of Murphy's Music School.",
      image: michelle,
      instrument: "Voice",
      hobbies: "Puzzles, Poetry",
    },
    {
      id: 6,
      name: "Shane Morrison",
      description1:
        "Shane Morrison, master of everything brass, has been internationally recognized for the past four decades as one of the leaders in the advancement of the tuba.",
      description2:
